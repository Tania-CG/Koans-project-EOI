...
class AboutStringManipulation(Koan):
    ...
    def test_any_python_expression_may_be_interpolated(self):
        ...
        string = "The square root of 5 is {0:.{1}f}".format(math.sqrt(5),
                                                            decimal_places)
        # DUDAAAA!!!! 4 decimales pero dónde indicas el redondeo ¿?
    ...
    def test_single_characters_can_be_represented_by_integers(self):
        ...
        self.assertEqual(True, ord('b') == (
            ord('a') + 1))  # No se que es el ord
    ...
    def test_raw_strings_do_not_interpret_escape_characters(self):
        ...
        self.assertNotEqual('\n', string)
        self.assertEqual(r'\n', string)
        self.assertEqual(2, len(string))  # DUDA
    ...
    def test_strings_can_change_case(self):
        ...
        self.assertEqual('Guido Van Rossum', 'guido van rossum'.title())  #Primera letra en mayúscula
        self.assertEqual('tOtAlLy AwEsOmE', 'ToTaLlY aWeSoMe'.swapcase())  # A la inversa

...
class AboutSets(Koan):
    ...
    def test_empty_sets_have_different_syntax_to_populated_sets(self):
        self.assertEqual(set([1, 2, 3]), {1, 2, 3})   # No me acordaba de esto
        # recuerda {} es un dict vacio, no te confundas
    ...
    def test_convert_the_set_into_a_list_to_sort_it(self):
        self.assertEqual(['1', '2', '3', '4', '5'], sorted(
            set('12345')))  # me costó caer en []
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'MacLeod', 'Wallace', 'Willie',
                          'Leonidas'}, scotsmen | warriors)  # uno U otro
        self.assertEqual({'MacLeod', 'Wallace'}, scotsmen &
                         warriors)  # coincida en los dos
    ...
    def test_we_can_compare_subsets(self):
        ...
        self.assertEqual(True, set('cake').issubset(
            set('cherry cake')))  # Durda

        self.assertEqual(False, set('cake') > set('pie')
                         )  # mal pero no sé por qué
